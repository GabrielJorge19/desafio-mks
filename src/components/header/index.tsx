...
export function Header(): React.JSX.Element {
    ...
    const [carrinhoActive, setCarrinhoActive] = useState(true);


    return <div style={styles.container}>
        <div style={styles.content}>

            <h1 style={styles.title}>MKS<span style={styles.titleSpan}> Sistemas</span></h1>
            <div style={styles.dadosCarrinho} onClick={() => { setCarrinhoActive(false)}}>
                ...
                <p style={styles.quant}>{carrinho!.length}</p>
            </div>
        </div>
        <Carrinho carrinhoActive={carrinhoActive} setCarrinhoActive={setCarrinhoActive} />
    </div>
}
